...
async def main():
    async with httpx.AsyncClient(timeout=None) as client:
        ...
        page_url = f"https://www.forexfactory.com/forum/137-interactive-trading?sort=lastpost&order=desc&page={number}"
        url_list = [page_url for page_url in range(page_start, page_stop)]
